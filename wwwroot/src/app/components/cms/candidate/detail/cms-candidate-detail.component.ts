...
@Component({
  selector: 'app-cms-candidate-detail',
  templateUrl: './cms-candidate-detail.component.html',
  styleUrls: ['./cms-candidate-detail.component.scss', './cms-candidate-detail.component.theme.scss'],
  providers: [CommonService, SnackBarService, UserService]
})
export class CmsCandidateDetailComponent extends AppCmsBaseComponent implements OnInit {
