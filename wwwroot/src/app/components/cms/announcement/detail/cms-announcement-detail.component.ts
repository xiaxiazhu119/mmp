...
@Component({
  selector: 'app-cms-announcement-detail',
  templateUrl: './cms-announcement-detail.component.html',
  styleUrls: ['./cms-announcement-detail.component.scss', './cms-announcement-detail.component.theme.scss'],
  providers: [CommonService, SnackBarService, UserService]
})
export class CmsAnnouncementDetailComponent extends AppCmsBaseComponent implements OnInit {
